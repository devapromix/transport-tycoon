...
type
  ...
  public
    ...
    property Houses: Word read FHouses write FHouses;
    property TownRace: TRaceEnum read FTownRace write FTownRace;
    procedure ModifyPopulation(const APopulation: Integer);
    property Airport: TAirport read FAirport write FAirport;
    property BusStation: TStation read FBusStation write FBusStation;
    property HQ: TStation read FHQ write FHQ;
